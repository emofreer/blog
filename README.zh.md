...
```
# Site settings
title: Hrc Blog             # 你的博客网站标题
SEOTitle: Hrc Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: Hrcpro     # 你的github账号
weibo_username: Hrcpro      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-Hrc.jpg     #你的大头贴，请使用绝对地址.
```
...
网站分析，现在支持百度统计和Google Analytics
